# Tessel application icons

`tessel-logo-source.png` is the supplied transparent master artwork.

- `icon_16x16.png` through `icon_1024x1024.png` are raster variants for development and platform fallback use.
